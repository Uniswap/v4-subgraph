...
export function handleInitializeHelper(
  ...
  if (poolManager === null) {
    ...
    poolManager.externalTotalValueLockedETH = ZERO_BD
    poolManager.externalTotalValueLockedUSD = ZERO_BD
  ...
  if (token0 === null) {
    ...
    token0.externalTotalValueLockedETH = ZERO_BD
    token0.externalTotalValueLockedUSD = ZERO_BD
  ...
  if (token1 === null) {
    ...
    token1.externalTotalValueLockedETH = ZERO_BD
    token1.externalTotalValueLockedUSD = ZERO_BD
