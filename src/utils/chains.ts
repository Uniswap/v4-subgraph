...
export function getSubgraphConfig(): SubgraphConfig {
  ...
  if (selectedNetwork == SEPOLIA_NETWORK_NAME) {
    return {
      ...
      stablecoinWrappedNativePoolId: Bytes.fromHexString(
    ...
    return {
      ...
      ), // https://unichain-sepolia.blockscout.com/tx/0x6461a80bbdd78222097c8f0437952dba852f25c3822df50660e347ccd6436f6f?tab=logs
      stablecoinIsToken0: true,
    ...
    return {
      ...
      ), // https://sepolia.basescan.org/tx/0xa8a8ad7ed9fe1e44ce264f240821a33bfd93a385397b46fd7142deee242be2fa#eventlog
      stablecoinIsToken0: true,
      wrappedNativeAddress: Address.fromString('0x4200000000000000000000000000000000000006'), // WETH
      minimumNativeLocked: BigDecimal.fromString('1'),
      stablecoinAddresses: [
      ...
      whitelistTokens: [
        ...
        Address.fromString('0x036cbd53842c5426634e7929541ec2318f3dcf7e'), // USDC
        Address.fromString('0x4200000000000000000000000000000000000006'), // WETH
        Address.fromString('0x1111111111166b7fe7bd91427724b487980afc69'), // ZORA
      ],
      tokenOverrides: [],
      poolsToSkip: [],
      poolMappings: [],
    ...
    return {
      ...
      ), // https://arbiscan.io/tx/0xd2542ab5fa8cb1b0606c6f114d9589e35db6d02dee426b7d874bda7c6e05f641#eventlog
    ...
    return {
      ...
      ), // https://basescan.org/tx/0xf7f4eb1aef74a635a1bf42d598049afbed8ec9e303be81bf168b94a71045decb#eventlog
      stablecoinIsToken0: false,
      wrappedNativeAddress: Address.fromString('0x4200000000000000000000000000000000000006'), // WETH
      minimumNativeLocked: BigDecimal.fromString('1'),
      stablecoinAddresses: [
    ...
    return {
      ...
      ), // https://polygonscan.com/tx/0x6c94e24c0ddff6dd9bfa860561945330c81df85ebb4b1ecf75a459b016719314
      stablecoinIsToken0: false,
    ...
    return {
      ...
      ), // https://bscscan.com/tx/0x36c1e4c7b4105a0be337addc32b5564dd3494fccfe331bf9fe7c647163d27d05#eventlog
      stablecoinIsToken0: true,
    ...
    return {
      ...
      ), // https://optimistic.etherscan.io/tx/0x5a7ce7eaa8a1ae27a84846b0152d2910ec8db0c4d62b0968e0a49830d882ad28
      stablecoinIsToken0: true,
      wrappedNativeAddress: Address.fromString('0x4200000000000000000000000000000000000006'), // WETH
      minimumNativeLocked: BigDecimal.fromString('1'),
      stablecoinAddresses: [
    ...
    return {
      ...
      ), // https://snowtrace.io/tx/0x008bbcac5d411e48621c94f75f3dedf025a031d2633a548fb372f45f73db111d/eventlog?chainid=43114
      stablecoinIsToken0: false,
    ...
    return {
      ...
      ), // https://worldchain-mainnet.explorer.alchemy.com/tx/0x042848d1377542415c68a8f8901923f2e54a4596016890eefb7c5094e45775d7?tab=logs
      stablecoinIsToken0: false,
      wrappedNativeAddress: Address.fromString('0x4200000000000000000000000000000000000006'), // WETH
      minimumNativeLocked: BigDecimal.fromString('1'),
      stablecoinAddresses: [
    ...
    return {
      ...
      ), // https://explorer.zora.energy/tx/0x8a0cd1856e3c95918e78478ccc993a6e745e364d5036852f44033827be880a17
      stablecoinIsToken0: false,
      wrappedNativeAddress: Address.fromString('0x4200000000000000000000000000000000000006'), // WETH
      minimumNativeLocked: BigDecimal.fromString('1'),
      stablecoinAddresses: [
    ...
    return {
      ...
      ), // https://etherscan.io/tx/0x4e63fcc0dd42a2b317e77d17e236cadf77464a08ccece33a354bd8648b5f7419#eventlog
      stablecoinIsToken0: true,
    ...
    return {
      ...
      stablecoinAddresses: [
        ...
        Address.fromString('0x9151434b16b9763660705744891fa906f660ecc5'), // USDT0
      ],
      whitelistTokens: [
        Address.fromString('0x4200000000000000000000000000000000000006'), // WETH
        Address.fromString('0x078d782b760474a361dda0af3839290b0ef57ad6'), // USDC
        ...
        Address.fromString('0x0000000000000000000000000000000000000000'), // Native ETH
        Address.fromString('0x9151434b16b9763660705744891fa906f660ecc5'), // USDT0
        Address.fromString('0x927b51f251480a681271180da4de28d44ec4afb8'), // WBTC
      ],
      tokenOverrides: [],
      poolsToSkip: [],
      poolMappings: [],
    ...
    return {
      poolManagerAddress: Address.fromString('0x360e68faccca8ca495c1b759fd9eee466db9fb32'),
      stablecoinWrappedNativePoolId: Address.fromString(
      ...
      minimumNativeLocked: BigDecimal.fromString('1'),
      stablecoinAddresses: [
        Address.fromString('0xba9986d2381edf1da03b0b9c1f8b00dc4aacc369'), // USDC
      ],
      whitelistTokens: [
        Address.fromString('0x4200000000000000000000000000000000000006'), // WETH
        Address.fromString('0xba9986d2381edf1da03b0b9c1f8b00dc4aacc369'), // USDC
